...
## Another way of thinking about arguments!
...
:::{.fragment}
Note that we don't need to worry about the output will be called.
...
## Convert common code to a function (2)
...
and outside it.
I didn't really get what the point was.
:::
